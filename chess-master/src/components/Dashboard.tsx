...
const Dashboard: React.FC<DashboardProps> = ({ userName, onLogout, onGameModeSelect }) => {
  ...
  const gameModes = [
    {
      title: "Sandbox",
      description: "Play with a friend locally. No time limits, no pressure - just pure chess enjoyment.",
      icon: Users,
    ...
    {
      title: "Easy Mode",
      description: "Perfect for beginners. Face an AI opponent designed to help you learn and improve your skills.",
      icon: Zap,
      difficulty: "Beginner",
    ...
    {
      title: "Hard Mode",
      description: "Challenge yourself against a formidable AI. Test your skills and strategic thinking.",
      icon: Brain,
      difficulty: "Expert",
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <p className="text-lg font-medium text-slate-700 dark:text-slate-300">
              Hi <span className="text-amber-600 font-semibold">{userName}</span>! 👋
            </p>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
            Whether you're practicing with friends, learning the basics, or testing your mastery, 
            we have the perfect game mode for you.
          </p>
        </div>
        ...
        <div className="mt-16 bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm rounded-3xl p-8 border border-slate-200 dark:border-slate-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-6 bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-900/20 dark:to-amber-800/20 rounded-2xl border border-amber-200 dark:border-amber-800/30">
              <div className="text-3xl font-bold text-amber-600 dark:text-amber-400 mb-2">{userStats.gamesPlayed}</div>
            ...
            <div className="text-center p-6 bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-2xl border border-green-200 dark:border-green-800/30">
              <div className="text-3xl font-bold text-green-600 dark:text-green-400 mb-2">{userStats.gamesWon}</div>
              <div className="text-slate-600 dark:text-slate-400">Games Won</div>
            </div>
            <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-2xl border border-blue-200 dark:border-blue-800/30">
              <div className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2">{userStats.winStreak}</div>
              <div className="text-slate-600 dark:text-slate-400">Win Streak</div>
            </div>
          </div>
        </div>
      </main>
